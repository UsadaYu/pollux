...
int main() {
  ...
  eargs.max_b_frames = 0;
  eargs.codec_id = ENCODE_ID;
  eargs.thread_count = 8;
  e->param_set(e, OUTPUT_FILE, &eargs);

  hevc_encode_args_t priv_args = {0};
  priv_args.speed_level = 16;
  priv_args.tune_mode = hevc_tune_zerolatency;
